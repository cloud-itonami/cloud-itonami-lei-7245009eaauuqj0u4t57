...
Randstad N.V., per ADR-2607110300 -- a read-only reference archive. As part
...
- **Company**: Randstad N.V., LEI 7245009EAAUUQJ0U4T57, website
  `https://www.randstad.com`.
- **Baseline provenance** (real, from this repo's own `80-data/public/
  tos.journal.edn`): source-url `https://www.randstad.com/terms-and-conditions/`,
