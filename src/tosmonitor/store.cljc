(ns tosmonitor.store
  ...
  This repo archives exactly ONE company (Randstad N.V.,
  LEI 7245009EAAUUQJ0U4T57) -- unlike `commitledger.store`'s multi-application
...
(def ^:private demo-full-text
  "Terms and Conditions\nBy using this website you agree to be bound by these Terms and Conditions. Randstad N.V., a global HR services and staffing company, provides the content of this site for informational purposes only and may update it at any time without notice. These Terms and Conditions are governed by the laws of the Netherlands.")

(defn demo-baseline []
  {:full-text    demo-full-text
   :source-url   "https://www.randstad.com/terms-and-conditions/"
